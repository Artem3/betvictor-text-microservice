...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"producer.topic.name"})
class KafkaProducerServiceTest {
    ...
    public void testSendMessage() throws Exception {
        ...
        var future = kafkaTemplate.send("producer.topic.name", "key", message);
        var future2 = kafkaTemplate.send("producer.topic.name", "key", message2);
